defmodule ExESDB.Snapshots do
  ...
  def init(opts) do
    ...
    children = [
      {PartitionSupervisor,
       ...
       name: StoreNaming.partition_name(ExESDB.SnapshotsWriters, store_id)},
      {PartitionSupervisor,
       child_spec: DynamicSupervisor,
       name: StoreNaming.partition_name(ExESDB.SnapshotsReaders, store_id)}
    ]
  ...
  ## Examples
      ...
      [:snapshots, "source_uuid", "stream_uuid", "0000000001"]
  """
  @spec path(
